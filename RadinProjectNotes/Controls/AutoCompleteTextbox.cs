namespace AutoCompleteTextBoxSample
{
    ...
    public class AutoCompleteTextbox : TextBox
    {
        ...
        public event EventHandler AutocompleteListItemSelected;
        ...
        private bool SelectItem()
        {
            ...
            if (((this.listBox.Items.Count > 0) && (this.SelectedIndex > -1)))
            {
                ...
                this.HideSuggestionListBox();
                //fire event
                AutocompleteListItemSelected(this, EventArgs.Empty);
            }
            return true;
        }
        ...
        private void UpdateCurrentAutoCompleteList()
        {
            ...
            {
                //create an alternative version of the text without '_'
                string altText = this.Text.Replace('_', ' ');
                string altStr = Str.Replace('_', ' ');
                // be casesensitive
                if (CaseSensitive)
                {
                    // search for the substring (equal to SQL Like Command)
                    if ((Str.IndexOf(this.Text) > -1) || (altStr.IndexOf(altText) > -1))
                ...
                else
                {
                    ...
                    if ((Str.ToLower().IndexOf(this.Text.ToLower()) > -1) || (altStr.ToLower().IndexOf(altText.ToLower()) > -1))
                    // Add candidates to new CurrentAutoCompleteList
                    { CurrentAutoCompleteList.Add(Str); }
                }
            }
        ...
        private void UpdateListBoxItems()
        {
            ...
            if (ParentForm != null)
            {
                ...
                if (!this.ParentForm.Controls.Contains(panel))
                {
                    // add the Panel and ListBox to the ParentForm
        ...
        public void ChangePanelFont(System.Drawing.Font font)
        {
            this.panel.Font = font;
            this.listBox.Font = font;
        }
